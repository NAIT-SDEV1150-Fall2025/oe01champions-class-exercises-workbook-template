...
class UserCard extends HTMLElement {
  constructor() {
    ...
    // Adding property to track follow state or you can sau, giving a memory to web component to remember if it is being followed or not.
  ...
  // A method call from main.js to follow the card.
  follow() {
    this._setFollow(true);
  }
  // A method call from main.js to un-follow the card.
  unfollow() {
    this._setFollow(false);
  }

  // define setFollow method.
  _setFollow(value){
    this._followed = value;
    console.log('The updated/changed value is :' + value);
  ...
  // get the current state of property: followed.
  ...
  // Lets define onFollow method here.
  _onFollow() {
